...
const CALCULATORS = [
  ...
  { name: "DSR & 대출 한도 계산기", href: "/calculators/dsr", icon: "📊", tag: "투자", badge: "NEW" },
  { name: "DTI & 주담대 상환비율 계산기", href: "/calculators/dti", icon: "📈", tag: "투자", badge: "NEW" },
  { name: "LTV & 주담대 한도 계산기", href: "/calculators/ltv", icon: "🏠", tag: "투자", badge: "NEW" },
  { name: "근저당 설정비용 계산기", href: "/calculators/mortgage-cost", icon: "🏦", tag: "투자", badge: "NEW" },
  { name: "재산세 계산기", href: "/calculators/property-tax", icon: "🏢", tag: "투자", badge: "NEW" },
  ...
  { name: "연봉 실수령액 계산기", href: "/calculators/salary", icon: "💸", tag: "생활" },
  { name: "카드·현금 영수증 소득공제 계산기", href: "/calculators/card-deduction", icon: "💳", tag: "생활", badge: "NEW" },
  { name: "알바 급여 계산기", href: "/calculators/part-time-salary", icon: "⏰", tag: "생활", badge: "NEW" },
  { name: "주휴수당 계산기", href: "/calculators/weekly-allowance", icon: "⏱️", tag: "생활", badge: "NEW" },
